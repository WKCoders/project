<div class="row">
    <div class="col-md-12">
	    ...
	    <?php echo $this->Html->link('<span class="fa fa-arrow-left"></span>&nbsp;Back To Deals',array('controller' => 'Deals','action'=>'index'),array('escape' => false,'class'=>'btn btn-info'));?>
            <?php $url=$this->Html->url(array('controller'=>'deals_payments')); echo $this->Html->link('<span class="fa fa-rupee"></span>&nbsp;Add New Payment',array('controller'=>'deals_payments','action'=>'add',$dealId),array('escape'=>false,'class'=>'btn btn-success'));?>
