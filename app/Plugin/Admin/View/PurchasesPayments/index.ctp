<div class="row">
    <div class="col-md-12">
	    ...
	    <?php echo $this->Html->link('<span class="fa fa-arrow-left"></span>&nbsp;Back To Purchase',array('controller' => 'Purchases','action'=>'index'),array('escape' => false,'class'=>'btn btn-info'));?>
            <?php $url=$this->Html->url(array('controller'=>'purchases_payments')); echo $this->Html->link('<span class="fa fa-rupee"></span>&nbsp;Add New Payment',array('controller'=>'purchases_payments','action'=>'add',$purchaseId),array('escape'=>false,'class'=>'btn btn-success'));?>
