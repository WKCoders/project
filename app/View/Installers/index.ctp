				...
				<div class="panel panel-default">
					...
					<?php echo $this->Form->create('Installer',array('controller' => 'Installer','action'=>'step1','name'=>'post_req','id'=>'post_req'));?>
					  ...
					  <?php echo $this->Session->flash();?>
						...
						<h3>Server Configuration &amp; Setup Requirements</h3>
						<div class="row">
						  <div class="col-md-6">
						    <div class="panel panel-default">
						      <div class="panel-heading"><span class="glyphicon glyphicon-wrench"></span> <strong>Setup Requirements</strong></div>
							<div class="panel-body">
							  Installing this software require certain server side extension and capability,
							please check below and compare with your server current statues on the right. You can click on the icon next to each technology for details.
						    ...
						    <div class="col-md-6">
						    <div class="panel panel-default">
						      <div class="panel-heading"><span class="glyphicon glyphicon-cog"></span> <strong>Server Status</strong></div>
							<div class="panel-body">							  
							  <div class="table-responsive">
							    <table class="table table-striped">
							      <thead>
