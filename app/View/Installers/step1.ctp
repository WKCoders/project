		...
		<div class="row">	
			<div  class="col-md-12 mrg">
				<div class="panel panel-default">
					<div class="panel-heading"><?php echo$this->Html->image('logo-website.fw.png',array('alt'=>'Real Estate CRM','class'=>'img-responsive'));?></div>
...
<p>This End User License Agreement is a binding legal agreement between you or your company and Silver Syclops Inc. Purchase, installation or use of Real Estate CRM provided on Silversyclops.net signifies that you have read, understood, and agreed to be bound by the terms outlined below. </p>

<br>
	<p><strong>SILVER SYCLOPS INC. GPL LICENSING </strong></p> 

<p>All products/scripts including Real Estate CRM is released under the GNU General Public License, version 2 (http://www.gnu.org/licenses/gpl-2.0.html). Specifically, the PHP code portions are distributed under the GPL license. If not otherwise stated, all images, manuals, cascading style sheets, and included JavaScript are NOT GPL, and are released under the Silver Syclops Inc. Use License v1.0 (See below) unless specifically authorized by Silver Syclops Inc. Elements of the extensions released under this proprietary license may not be redistributed or repackaged for use other than those allowed by the Terms of Service. </p>
<br>

<p> <strong>SILVER SYCLOPS INC. PROPRIETARY USE LICENSE (v1.0) </strong></p>
<p>The Silver Syclops Inc. Proprietary Use License covers any images, cascading style sheets, manuals and JavaScript files in any extensions produced and/or distributed by Silversyclops.net. These files are copyrighted by Silver Syclops Inc. and cannot be redistributed in any form without prior consent from us.</p>
<br>
...
<p>
Standard Licence holders must display the Silversyclops.net back link in an un-alerted state. Sites with modified or removed back links will not be supported
<br></p>
	...
	<div class="container">
		<div class="panel panel-success">
			<div class="panel-footer">
				<div class="row">					
					<div class="col-md-12 text-center">Visit our website <?php echo$this->Html->link('http://www.rolftask.in','http://www.rolftask.in/',array('target'=>'_blank'));?> for documentation and support</div>
			</div>
		</div>
	</div>
  </body>
